...
/* USER CODE BEGIN EV */
uint8_t HardInt_receive_str[25];//接收蓝牙发来的消息
uint8_t HardInt_uart_flag=0;//串口中断更新flag
uint8_t HardInt_mpu_flag=0;//没用到
uint8_t HardInt_Charg_flag=0;//充电标志位
/* USER CODE END EV */
